...
Connection.prototype = {
  connect: function connect() {
    var _this = this;
    return new Bluebird(function connectPromise(resolve, reject) {
      ...
      _this._connection.on('error', function(err) {
        var error = new errors.ConnectionError(_this.username, _this.host);
        reject(error);
      });

      _this._connection.connect(_this.options);
    });
  },
